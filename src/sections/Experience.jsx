...
const experiences = [
    {
        ...
        duration: "2023-2026",
        description: "Build user friendly E-Commerce website design"
    },
    {
        role: "Frontend Developer",
        company: "Self Project",
    ...
    function ExperinceItem({exp, idx, start, end, scrollYProgress, layout}) {
    ...
    if(layout === "desktop") {
        return (
            <div className=' relative flex flex-1 justify-center items-center min-w-0'>
                ...
                <motion.article className={`absolute ${idx%2 === 0 ? "bottom-12" : "top-12"} bg-gray-900/80 backdrop-blur border border-gray-700/70 rounded-xl p-7 w-80 shadow-lg`}
        ...
        <div className=' relative flex items-start'>
            ...
            style={{scale, opacity}}
            ></motion.div>
            <motion.article className='bg-gray-900/80 backdrop-blur border border-gray-700/70 rounded-xl p-2 w-[90vw] max-w-sm ml-5 shadow-lg'
            style={{opacity, x}}
            transition={{duration: 0.4, delay: idx*0.15}}
            >
                    ...
                    {isMobile && (
                        <div className='relative w-full max-w-md h-screen'>
                            <div className=' absolute left-0 top-0 bottom-0 w-1.5 bg-white/15 rounded'>
                                <motion.div className=' absolute top-0 left-0 w-1.5 bg-white origin-top rounded'
                                style={{height: "100vh"}}
                                >
                                </motion.div>
                            </div>
